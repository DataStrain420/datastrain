...
GROWERS = [
    {"name": "GW Pharmaceuticals", "country_of_origin": "United Kingdom", "verified": True,
     "phone_number": "+44 1980 557 100",
     "address_street": "Sovereign House, Vision Park", "address_city": "Cambridge",
     "address_postcode": "CB24 9BZ", "address_country": "United Kingdom"},
    {"name": "Northern Leaf", "country_of_origin": "United Kingdom", "verified": True,
     "phone_number": "+44 1534 280 280",
     "address_street": "Le Hocq Lane", "address_city": "St Clement, Jersey",
     "address_postcode": "JE2 6FN", "address_country": "United Kingdom"},
    {"name": "Dalgety", "country_of_origin": "United Kingdom", "verified": True,
     "phone_number": "+44 1424 575 575",
     "address_city": "Sussex", "address_country": "United Kingdom"},
    {"name": "Glass Pharms", "country_of_origin": "United Kingdom", "verified": True,
     "phone_number": "+44 20 8617 9999",
     "address_city": "Bedford", "address_country": "United Kingdom"},
    {"name": "PLF Pharma", "country_of_origin": "Germany", "verified": True,
     "address_city": "Frankfurt", "address_country": "Germany"},
    {"name": "Tilray", "country_of_origin": "Canada", "verified": True,
     "phone_number": "+1 855 295 8254",
     "address_street": "655 Madison Avenue, 19th Floor", "address_city": "New York",
     "address_postcode": "NY 10065", "address_country": "United States"},
    {"name": "Aurora", "country_of_origin": "Canada", "verified": True,
     "address_city": "Edmonton, Alberta", "address_country": "Canada"},
    {"name": "Bedrocan", "country_of_origin": "Netherlands", "verified": True,
     "phone_number": "+31 599 363 800",
     "address_street": "Cannabislaan 1", "address_city": "Veendam",
     "address_postcode": "9641 KW", "address_country": "Netherlands"},
    {"name": "Noidecs", "country_of_origin": "Portugal", "verified": True,
     "address_city": "Lisbon", "address_country": "Portugal"},
    {"name": "Khiron", "country_of_origin": "Colombia", "verified": True,
     "address_city": "Bogotá", "address_country": "Colombia"},
    {"name": "Grow Pharma", "country_of_origin": "United Kingdom", "verified": True,
     "phone_number": "+44 20 3941 6111",
     "address_city": "London", "address_country": "United Kingdom"},
    {"name": "BOL Pharma", "country_of_origin": "Israel", "verified": True,
     "address_city": "Revadim", "address_country": "Israel"},
    {"name": "Cellen", "country_of_origin": "United Kingdom", "verified": True,
     "address_city": "London", "address_country": "United Kingdom"},
    {"name": "Cantourage", "country_of_origin": "Germany", "verified": True,
     "phone_number": "+49 30 5800 8800",
     "address_street": "Pohlstraße 20", "address_city": "Berlin",
     "address_postcode": "10785", "address_country": "Germany"},
    {"name": "Lyphe Group", "country_of_origin": "United Kingdom", "verified": True,
     "phone_number": "+44 20 7193 1864",
     "address_city": "London", "address_country": "United Kingdom"},
    {"name": "Althea", "country_of_origin": "Australia", "verified": True,
     "address_city": "Melbourne, VIC", "address_country": "Australia"},
    {"name": "MedCan", "country_of_origin": "Australia", "verified": True,
     "address_city": "Sydney, NSW", "address_country": "Australia"},
    {"name": "Fotmer", "country_of_origin": "Uruguay", "verified": True,
     "address_city": "Nueva Helvecia", "address_country": "Uruguay"},
]
...
CLINICS = [
    {"name": "Sapphire Medical Clinics", "location": "London (Harley Street)", "website": "https://sapphireclinics.com", "description": "MHRA-registered specialist clinic with the UK Medical Cannabis Registry; consultants across pain, mental health and neurology.", "specialties": '["Chronic pain", "Anxiety", "PTSD", "Sleep disorders", "Neurological"]', "consultation_fee_gbp": 150, "consultation_style": "Video first appointment, in-person follow-ups available at the London clinic.", "cqc_report_url": "https://www.cqc.org.uk/location/1-10148716421", "verified": True},
    {"name": "Lyphe Clinic", "location": "London", "website": "https://lyphe.com", "description": "Formerly The Medical Cannabis Clinics. One of the longest-running prescribers in the UK with a large multi-disciplinary consultant team.", "specialties": '["Chronic pain", "Anxiety", "ADHD", "Cancer-related symptoms", "Palliative care"]', "consultation_fee_gbp": 100, "consultation_style": "Video consultations UK-wide; in-person available in London.", "cqc_report_url": "https://www.cqc.org.uk/location/1-9421283099", "verified": True},
    {"name": "Mamedica", "location": "London", "website": "https://mamedica.co.uk", "description": "Fixed monthly subscription model — initial assessment plus all follow-ups and reissues bundled into one fee.", "specialties": '["Chronic pain", "Anxiety", "PTSD", "Insomnia"]', "consultation_fee_gbp": 50, "consultation_style": "Video only — £50/month subscription includes unlimited follow-ups.", "cqc_report_url": "https://www.cqc.org.uk/location/1-12824987520", "verified": True},
    {"name": "Releaf", "location": "Cambridge", "website": "https://releaf.co.uk", "description": "All-in-one subscription bundling consultations, prescription delivery and medication into a single monthly fee.", "specialties": '["Chronic pain", "Anxiety", "Sleep disorders", "ADHD"]', "consultation_fee_gbp": 50, "consultation_style": "Video appointments only; medication delivered to your door.", "cqc_report_url": "https://www.cqc.org.uk/location/1-13219048721", "verified": True},
    {"name": "Curaleaf Clinic", "location": "Stoke-on-Trent / online UK-wide", "website": "https://curaleafclinic.com", "description": "Specialist team across pain, neurology and mental health; vertically integrated with Curaleaf Pharmacy.", "specialties": '["Chronic pain", "Anxiety", "PTSD", "Neurological", "Oncology"]', "consultation_fee_gbp": 100, "consultation_style": "Video first appointment, in-person follow-ups at Stoke-on-Trent.", "cqc_report_url": "https://www.cqc.org.uk/location/1-10148720913", "verified": True},
    {"name": "Alternaleaf", "location": "London (online UK-wide)", "website": "https://alternaleaf.co.uk", "description": "Australian-origin clinic that launched UK operations in 2024 — fast online triage and prescriber assignment.", "specialties": '["Chronic pain", "Anxiety", "ADHD", "Endometriosis"]', "consultation_fee_gbp": 75, "consultation_style": "Video only — online triage matches you to a specialist within 48 hours.", "cqc_report_url": "https://www.cqc.org.uk/location/1-14782693014", "verified": True},
    {"name": "Cantourage Clinic UK", "location": "London", "website": "https://cantourageclinic.co.uk", "description": "UK arm of German licensed producer Cantourage; consultants across pain, mental-health and neurology.", "specialties": '["Chronic pain", "Anxiety", "Migraine", "Fibromyalgia"]', "consultation_fee_gbp": 95, "consultation_style": "Video appointments UK-wide.", "cqc_report_url": "https://www.cqc.org.uk/location/1-13598274210", "verified": True},
    {"name": "Integro Medical Cannabis Clinics", "location": "Reading, Berkshire", "website": "https://integroclinics.com", "description": "Specialist clinic with a long-standing focus on chronic pain and complex multi-morbidity cases.", "specialties": '["Chronic pain", "Fibromyalgia", "Cancer pain", "Neuropathic pain"]', "consultation_fee_gbp": 120, "consultation_style": "Initial in-person assessment at Reading; video for follow-ups.", "cqc_report_url": "https://www.cqc.org.uk/location/1-11248702341", "verified": True},
    {"name": "Birmingham Cannabis Clinic", "location": "Birmingham", "website": "https://birminghamcannabisclinic.com", "description": "Independent Midlands-based clinic offering in-person and remote appointments for medical cannabis assessment.", "specialties": '["Chronic pain", "Anxiety", "Insomnia"]', "consultation_fee_gbp": 110, "consultation_style": "In-person at Birmingham, or video for return patients.", "verified": False},
    {"name": "Onyx Medical Cannabis Clinic", "location": "London", "website": "https://onyxmedical.co.uk", "description": "Boutique private clinic with same-week appointments and follow-up via secure messaging.", "specialties": '["Chronic pain", "Anxiety", "PTSD"]', "consultation_fee_gbp": 200, "consultation_style": "Concierge model — in-person London or video, with messaging support.", "verified": False},
    {"name": "LVL Health", "location": "London", "website": "https://lvlhealth.uk", "description": "Patient-membership model with bundled consultations and an in-app symptom tracker.", "specialties": '["Chronic pain", "Sleep disorders", "Anxiety"]', "consultation_fee_gbp": 80, "consultation_style": "Video only via mobile app — includes built-in symptom tracking.", "verified": False},
    {"name": "Cancard Wellford Clinic", "location": "Online UK-wide", "website": "https://wellfordmedical.co.uk", "description": "Online-first clinic associated with the Cancard patient advocacy programme; focus on accessibility.", "specialties": '["Chronic pain", "Anxiety", "Inflammatory bowel disease"]', "consultation_fee_gbp": 60, "consultation_style": "Video appointments UK-wide.", "verified": False},
]
